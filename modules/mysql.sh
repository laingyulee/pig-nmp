...
mysql_install_mysql() {
    ...
    local deb_url="https://dev.mysql.com/get/mysql-apt-config_0.8.33-1_all.deb"
...
mysql_install_mariadb() {
    ...
    local repo_line="deb [signed-by=${keyring}] https://deb.mariadb.org/${version}/${OS_ID} ${OS_CODENAME} main"
